        ...
        try {
            ...
            const tendenciesData = (posts || []).map(post => {
                ...
                if (tagMatch) {
                    ...
                    const bottomKeywords = /留ㅼ“|???щ젅?대툕|?꾨젅??留덉“?덉뒪???쒕툕誘몄떆釉?諛뷀?|bottom|submissive/i;
                    if (bottomKeywords.test(rawTitle)) type = 'bottom';
                }

                // 3) Try to extract English sub name from parenthesis e.g. "留덉뒪??(Master)"
            ...
            mainContent.innerHTML = `
                <div class="kink-dict-wrapper">
                    <div class="kink-dict-header">
                        ...
                        <p class="kink-dict-subtitle">?꾩쭅 ?깅줉???깊뼢???놁뒿?덈떎.</p>
                    </div>
                    <div style="text-align:center; padding: 3rem 1rem; color: var(--text-secondary);">
                        <p>愿由ъ옄 ?섏씠吏?먯꽌 寃뚯떆湲???묒꽦?섍퀬 <strong>?깊뼢 諛깃낵</strong> 移댄뀒怨좊━瑜??좏깮?섎㈃ ?ш린???쒖떆?⑸땲??</p>
                        <p style="margin-top:1rem; font-size:0.85rem; opacity:0.7;">?쒕ぉ ?욎뿉 <code>[top]</code> ?먮뒗 <code>[bottom]</code>??遺숈씠硫??먮룞 遺꾨쪟?⑸땲??<br>?? <code>[top] 留덉뒪??(Master)</code></p>
                    </div>
                </div>
            `;
            return;
