...
(function () {
    ...
    // Standardized admin email from core.js
    const ADMIN_EMAIL = window.ADMIN_EMAIL || 'dptpal0@gmail.com';
    ...
    async function init() {
        ...
        if (!window.SML_CORE) {
            console.error('❌ SML_CORE missing');
            return;
        }

        // Wait for config and client via SML_CORE
